...
export function createStatsCard({
  ...
  if (sparklineData && sparklineData.length > 1) {
    ...
    // Import and use sparkline component
    import("./sparkline.js").then(({ createSparkline }) => {
 ...
 * Create stats grid
 */
export function createStatsGrid(statsArray) {
 ...
 */
export function updateStatsCardValue(card, newValue) {
