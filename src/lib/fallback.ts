...
const DEFAULT_FALLBACKS: Record<string, Array<string>> = {
  ...
  // GPT models
  "gpt-5.4": ["gpt-5.3", "claude-sonnet-4.5", "gpt-5"],
  "gpt-5.3": ["gpt-5.2", "claude-sonnet-4.5", "gpt-5"],
  "gpt-5.3-codex": ["gpt-5.2", "claude-sonnet-4.5", "gpt-5"],
  "gpt-5.2": ["gpt-5.1", "claude-sonnet-4.5", "gpt-5"],
  "gpt-5.1": ["gpt-5", "claude-sonnet-4.5", "gpt-4o"],
  "gpt-5": ["gpt-4o", "claude-sonnet-4.5", "gpt-4.1"],
  "gpt-4o": ["gpt-4.1", "claude-sonnet-4.5", "gpt-4"],
  "gpt-4.1": ["gpt-4o", "claude-sonnet-4.5", "gpt-4"],
  "gpt-4": ["gpt-4o", "claude-sonnet-4.5", "gpt-4.1"],
  "gpt-4o-mini": ["gpt-3.5-turbo", "claude-sonnet-4.5", "gpt-4o"],
